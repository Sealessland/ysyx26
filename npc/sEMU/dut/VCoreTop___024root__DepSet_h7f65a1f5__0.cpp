...
VL_INLINE_OPT void VCoreTop___024root___nba_sequent__TOP__0(VCoreTop___024root* vlSelf) {
    ...
    // Body
    if ((((1U == (IData)(vlSelfRef.CoreTop__DOT___exu_io_out_bits_memCmd)) 
          | (2U == (IData)(vlSelfRef.CoreTop__DOT___exu_io_out_bits_memCmd))) 
         & (2U == (IData)(vlSelfRef.CoreTop__DOT___exu_io_out_bits_memCmd)))) {
        VCoreTop___024unit____Vdpiimwrap_pmem_write_TOP____024unit((QData)((IData)(vlSelfRef.CoreTop__DOT__exu__DOT__alu__DOT__casez_tmp)), (QData)((IData)(vlSelfRef.CoreTop__DOT___regfile_io_rs2_data)), 
                                                                   ((3U 
    ...
    if ((0x100073U == vlSelfRef.CoreTop__DOT___ifu_io_nextStage_bits_inst)) {
    ...
    __Vtemp_1 = ((IData)(vlSelfRef.reset) ? 0x80000000U
                  : (((1U == (IData)(vlSelfRef.CoreTop__DOT___idu_io_out_bits_bruOp))
                           ...
                           : ((3U == (IData)(vlSelfRef.CoreTop__DOT___idu_io_out_bits_bruOp))
                               ...
                               : ((4U == (IData)(vlSelfRef.CoreTop__DOT___idu_io_out_bits_bruOp))
                                   ...
                                   : ((5U == (IData)(vlSelfRef.CoreTop__DOT___idu_io_out_bits_bruOp))
                                       ? (vlSelfRef.CoreTop__DOT___regfile_io_rs1_data 
                                          < vlSelfRef.CoreTop__DOT___regfile_io_rs2_data)
                                       : ((6U == (IData)(vlSelfRef.CoreTop__DOT___idu_io_out_bits_bruOp))
                                           ? (vlSelfRef.CoreTop__DOT___regfile_io_rs1_data 
                                              >= vlSelfRef.CoreTop__DOT___regfile_io_rs2_data)
                                           : ((7U == (IData)(vlSelfRef.CoreTop__DOT___idu_io_out_bits_bruOp)) 
                                              | (8U 
